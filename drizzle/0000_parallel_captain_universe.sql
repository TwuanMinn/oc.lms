...
CREATE TABLE "learning_streaks" (
	...
	"lessons_completed" integer DEFAULT 1 NOT NULL,
	CONSTRAINT "uq_streak_day" UNIQUE("user_id","activity_date")
);
--> statement-breakpoint
...
CREATE INDEX "idx_streaks_user" ON "learning_streaks" USING btree ("user_id");--> statement-breakpoint
